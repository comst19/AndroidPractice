...
import com.comst19.newsapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private val retrofit = Retrofit.Builder()
        ...
        .addConverterFactory(
            TikXmlConverterFactory.create(
                TikXml.Builder()
                    .exceptionOnUnreadXml(false) // 필요한 데이터만 사용할 것이기 때문
                    .build()
            )
        ).build()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.feedChip.setOnClickListener {
            ...
            // api 호출, 리스트 변경
            newsService.mainFead().submitList()
