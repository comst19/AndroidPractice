...
import com.comst19.weatherforecastapp.databinding.ItemForecastBinding
...
object WeatherRepository {
    ...
    private val retrofit = Retrofit.Builder()
        .baseUrl("http://apis.data.go.kr/") // http 허용
    ...
    fun getVillageForecast(
        ...
        service.getVillageForecast(
            serviceKey = "ua1uJvsBUNoY51dau9HgWGvkyMJ4SrfaWBOl4KKOFN8mCUCN2Ne1ZwDyl9qfUtpPKhKWSlp+qWyWkb9edt7DMA==",
